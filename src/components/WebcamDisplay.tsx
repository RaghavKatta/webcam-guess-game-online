...
const WebcamDisplay = () => {
  ...
  return <div className="flex flex-col items-center gap-4">
      <div className="webcam-container w-full max-w-2xl bg-white border-4 border-white rounded-xl relative overflow-hidden h-[400px]">
        ...
        {!webcamActive && !loading && !error && <div className="absolute inset-0 flex items-center justify-center">
        ...
        {webcamActive && gameState === 'playing' && <div className="absolute top-0 inset-x-0 p-4 flex justify-between">
        ...
        {webcamActive && gameState === 'roundEnd' && <div className="absolute inset-0 flex items-center justify-center bg-black/60">
        ...
        {webcamActive && gameState === 'playing' && <div className="absolute bottom-0 inset-x-0 p-4">
      ...
      {webcamActive && <Button variant="outline" onClick={stopWebcam} className="border-game-red text-game-red hover:bg-game-red/10 font-semibold">
